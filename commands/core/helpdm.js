...
exports.run = async (client, message, args, level) => {
  ...
  let embed = new Discord.RichEmbed()
    ...
    .setDescription(`Here is a list of all the commands I can do`)
    .setTimestamp()
    .setColor("#FF4D9C")
    .setFooter(
    ...
    .addField(
      ...
      "`angry`, `bad`, `badass`, `bite`, `blush`, `congrats`, `cry`, `cuddle`, `evil`, `excited`, `highfive`, `hug`, " +
        "`kiss`, `laugh`, `lewd`, `lick`, `no`, `nosebleed`, `pat`, `peek`, `poke`, `sad`, `scared`, " +
        "`slap`, `sleepy`, `tantrum`, `wasted`, `wow`, `yes`",
      false
    )
